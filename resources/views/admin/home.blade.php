<x-admin-layout>
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-6">
            <div class="card-style">
                <h2 class="text-xl font-bold mb-3">Top Selling products</h2>
    ...
    <script>
        ...
        function fetchData() {
            ...
            fetch('/chart-data')
                ...
                .then(data => {
                    ...
                    updateTopSellingProductsChart(data.topSellingProducts);
                })
        ...
        function updateRecentOrderChart(recentOrderData) {
            ...
            var labels = recentOrderData.map(item => item.date);
        ...
        // Function to update Top Selling Products chart
        function updateTopSellingProductsChart(topSellingProducts) {
            // Extract product names and total quantities
            var labels = topSellingProducts.map(item => item.title); // Assuming you have product names in the result
            var data = topSellingProducts.map(item => item.total_quantity);
